...
| C3 Requirements                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <p><strong>R1.</strong> Each data model used shall have at least one defined machine-readable serialisation in an open, publicly available and implementation-independent data format.</p><p><strong>R2.</strong> The documentation of the data format should be sufficient to allow the creation of non-proprietary application or interpretor that is able to reconstruct all the data stored in such a data format.</p><p><strong>R3.</strong> Where multiple data formats are supported for the same data model, they shall represent the same information content consistently and without loss of meaning.</p><p><strong>R4.</strong> The representation should support validation using openly published schemas, grammars, or equivalent machine-readable constraints, where such validation mechanisms exist for the chosen format.</p> |
