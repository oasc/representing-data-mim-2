...
**C3**: **Data models can be serialised in open, standardised data formats so that data can be exchanged and interpreted consistently by different tools and implementations.**

| C2 Requirements                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><strong>R1.</strong> Each data model used shall have at least one defined machine-readable serialisation in an open, publicly available and implementation-independent data format.</p><p><strong>R2.</strong> The serialisation format(s) used shall be documented explicitly, including encoding rules, structural constraints, naming conventions, data types, and any applicable profiles or schemas needed for correct interpretation.</p><p><strong>R3.</strong> The serialised representation shall be processable by commonly available tools without requiring proprietary software, undocumented transformations, or vendor-specific extensions.</p><p><strong>R4.</strong> Where multiple serialisation formats are supported for the same data model, they shall represent the same information content consistently and without loss of meaning.</p><p><strong>R5.</strong> The serialised representation should support validation using openly published schemas, grammars, or equivalent machine-readable constraints, where such validation mechanisms exist for the chosen format.</p> |
